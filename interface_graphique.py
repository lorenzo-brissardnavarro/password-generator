...
def page_choix():
    ...
    label_choix.config(text=f"Bonjour {nom_utilisateur}")
...
pady=15, cursor="hand2", highlightthickness=0, command=page_choix)
...
label_choix = Label(frame_choix, text="", font=("Helvetica", 27, "bold"), fg="#0B3669", bg="#C5E8FC")
label_choix.pack()
